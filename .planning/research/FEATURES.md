...
5. **Chế độ Study Mode**: Nút gạt thủ công để xác nhận đang học tập trên các nền tảng dễ gây xao nhãng (YouTube/Browser).
6. **Lịch sử tập trung**: Biểu đồ hoặc thống kê đơn giản về thời gian "Deep Work" trong ngày.

## Future Ideas (Backlog)
- Tích hợp thêm âm thanh (Future-tech sound effects).
- Cho phép người dùng tùy chỉnh "tính cách" của Pet (Ví dụ: Hardcore cà khịa vs Gentle encouragement).
